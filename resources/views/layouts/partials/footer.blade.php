<footer class="text-white pt-5 pb-3" style="background-color: #2e4528;">
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-6">
                <div class="d-flex align-items-center mb-3">
                    <a href="#" class="text-white fs-5 me-3"><i class="bi bi-youtube"></i></a>
                    ...
                    <a href="#" class="text-white fs-5 me-3"><i class="bi bi-tiktok"></i></a>
                    <a href="#" class="text-white fs-5"><i class="bi bi-twitter-x"></i></a>
                </div>

                <p class="fw-bold mb-1">Dinas Pertanian Kota Padang</p>
                <p class="small mb-3">Jl. Raya Sei Lareh, Lubuk Minturun, Kec. Koto Tangah, Kota Padang, Sumatera Barat 25586</p>

                <ul class="list-unstyled small">
                    <li class="mb-1"><i class="bi bi-whatsapp me-2"></i> WhatsApp: 0812-3456-7890</li>
                    <li class="mb-1"><i class="bi bi-globe me-2"></i> Website: www.distan.padang.go.id</li>
        ...
        <div class="text-center small">
            <p class="mb-0">Copyright © 2025 Dinas Pertanian Kota Padang. All Rights Reserved.</p>
        </div>
    </div>
</footer>
